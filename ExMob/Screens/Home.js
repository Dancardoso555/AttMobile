...
export default function Home(){
    return(
            ...
            <Text style={estilo.containertexto}>O que é o conceito de natureza?
            Se refere à vida e aos elementos e fenômenos presentes no meio ambiente. Em geral, não inclui as obras e consequências das atividades humanas. A palavra provém do latim natura, que significa “qualidade essencial, disposição inata, o curso das coisas e o próprio universo”.</Text>
        
        <View>
        </View>

        <View style={estilo.containerImages}>
        <Image style={estilo.tamanhoImg} source={require('../assets/natureza.jpg')}/>
        <Image style={estilo.tamanhoImg} source={require('../assets/nature.jpg')}/>
        <Image style={estilo.tamanhoImg} source={require('../assets/download.jpg')}/>
        ...
        <View style={estilo.containertexto1}>
         ...
         A natureza é essencial para a vida de todos os seres vivos que dependem dos seus recursos. Isto é, água potável, florestas, outros animais, alimentos, oxigênio, clima e solo fértil. Além dos elementos naturais, os processos naturais como o ciclo da água, o ciclo do carbono e o ciclo dos nutrientes são fundamentais.
            
        </Text></View>
        <View style={estilo.containertexto2}>
         <Text style={estilo.containertexto2}>
         A natureza é composta por tudo o que existe no universo, desde as partículas subatômicas até as galáxias. 
Elementos da natureza 
Terra, Água, Fogo, Ar, Minerais, Folhas, Madeira, Rochas.
Seres vivos Plantas, Animais, Microorganismos, Seres humanos. 
